...
data class ScannerConfig(
    ...
    val jpegQuality: Int,
    val imageEnhancement: String,
    val autoOrientation: String,
    ...
    companion object {
        fun fromMap(m: Map<String, Any?>): ScannerConfig = ScannerConfig(
            ...
            imageEnhancement = m["imageEnhancement"] as? String ?: "none",
            autoOrientation = m["autoOrientation"] as? String ?: "none",
